    ...
    e.prototype = {
        ...
        "_clickEvents": function() {
            function c() {
                if (a("#jarviswidget-fullscreen-mode").length) {
                    ...
                    a('#content').css('position','relative');
                    var c = a(b).height(),
                    ...
                    a('#jarviswidget-fullscreen-mode .qvplaceholder').height(c - e - 15);
                }
                else{
                    a('#main').css('position','inherit');
                    a('#content').css('position','inherit');
                }
            }
            var d = this,
            ...
            e.on(g, ".jarviswidget-toggle-btn", function(b) {
                ...
                var e = a(this).parents(d.o.widgets),
                    f = e.children("div");
                d._runLoaderWidget(a(this)), a("#jarviswidget-fullscreen-mode").length
                    ?
                        (a(".nooverflow").removeClass("nooverflow"),
                        e.find(".qvplaceholder").height(e.find(".qvplaceholder").attr('oriSize'))    ,
                        e.unwrap("<div>").children("div").removeAttr("style").end().find(".jarviswidget-fullscreen-btn:first").children().removeClass(d.fullscreenClass[1]).addClass(d.fullscreenClass[0]).parents(d.pwCtrls).children("a").show(),
                        f.hasClass("jarviswidget-visible") && f.hide().removeClass("jarviswidget-visible"))
                    : (a("body").addClass("nooverflow"),
                        e.wrap('<div id="jarviswidget-fullscreen-mode"/>').parent().find(".jarviswidget-fullscreen-btn:first").children().removeClass(d.fullscreenClass[0]).addClass(d.fullscreenClass[1]).parents(d.pwCtrls).children("a:not(.jarviswidget-fullscreen-btn)").hide(), f.is(":hidden") && f.show().addClass("jarviswidget-visible")), c(), "function" == typeof d.o.onFullscreen && d.o.onFullscreen.call(this, e), b.preventDefault()
        ...
        "destroy": function() {
            var c = this,
             ...
             c.widget.children("header").off(d), a(c.o.deleteSettingsKey).off(d), a(c.o.deletePositionKey).off(d), a(b).off(d), c.obj.removeData(f)
        }
    }, a.fn[f] = function(b) {
